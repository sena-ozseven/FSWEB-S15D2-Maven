...
public class StringSet {
    public static Set<String> findUniqueWords() {
        ...
        String[] cleanedWords = text.toLowerCase().replaceAll("[^a-zA-Z\\s]", "").split("\\s+");
        TreeSet<String> strings = new TreeSet<>(List.of(cleanedWords));
        System.out.println("Number of unique words: " + strings.size());
        return strings;
    }
